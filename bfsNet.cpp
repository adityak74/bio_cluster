...
;
  ...
  // we call modularity instead of bfs
  sparseNet.setGlobalNetworkGE(); // set the global vertices and edges number.

  // you can uncomment this to see the modularity change
  //sparseNet.removeEdge(0, 1); // remove edge (1,2)
  //sparseNet.modularity(argv[2]);
